                    ...
                    <table>
                        <tr>
                            <td rowspan="4" style="width: 220px;">
                                <div class="image">
                                    <img src="<?php if($nameFile == '-'){echo 'img/57-577367_tiger-png-logo-free-tiger-logo-png-clipart.png';}else{echo 'public/files/'.$nameFile;}?>" alt="upload" height="300px" width="300px">
                                </div>
                            </td>
